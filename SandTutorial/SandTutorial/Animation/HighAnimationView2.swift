//
//  HighAnimationView2.swift
//  SandTutorial
//
//  Created by YuSeongChoi on 2022/10/13.
//

import SwiftUI

struct HighAnimationView2: View {
    var body: some View {
        HelloThere()
            .padding(100)
            .background(.black)
...
struct Emoji: View {
    ...
    @State private var kf: KeyFrame? = nil
...
struct HighAnimationView2_Previews: PreviewProvider {
