...
public struct HeroConfiguration {
    ...
    /// Zoomed factor of thumbnail images. It is kept valid by checking with lowestFactor and highestFactor.
    /// These are determine by the thumbnail size.
    ...
    /// Lowest scaling factor possible for the current thubnail size
