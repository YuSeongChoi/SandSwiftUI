    ...
    var body: some View {
        ZStack {
            ...
            GeometryReader { proxy in
                ...
                .frame(width: proxy.size.height, height: proxy.size.width) // Height & width swap
...
struct TabBar: View {
    var body: some View {
        HStack(spacing: 32) {
            TabBarIcon2(icon: "photo.on.rectangle.angled", isActive: true)
            TabBarIcon2(icon: "person.crop.circle")
        }
