...
//  SandTutorial
//
//  Created by YuSeongChoi on 2022/12/21.
//
...
struct SlidingTabProgressiveSelectionView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            SlidingTabBar(selection: $tabBarSelection, tabs: ["First", "Second"]) { newValue in
            ...
            TabView(selection: $tabViewSelection) {
                ...
                .tag(0)
                .readFrame(in: .named(coordinateSpaceName)) { frame in
...
struct SlidingTabSelectionView: View {
    
    @State private var selection: Int = 0
    
    var body: some View {
        VStack(alignment: .leading) {
            SlidingTabBar(selection: $selection, tabs: ["First", "Second"])
